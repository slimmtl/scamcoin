...
uint256 hashGenesisBlock("0x0d81ddb2788349029de9cacad6b9c2c0090120f1be7c6363ce70721b236fbf49");
...
static const int64 nTargetTimespan = 7 * 24 * 60 * 60; // ScamCoin: 1 days
static const int64 nTargetSpacing = 777; // ScamCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal scamcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ScamCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0d81ddb2788349029de9cacad6b9c2c0090120f1be7c6363ce70721b236fbf49");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "This scam is timeless";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1399598000; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1198706;

        if (fTestNet)
        {
            block.nTime    = 1399698000; // 1300000000;
            block.nNonce   = 1198706;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5e3d23c3bdd8c5218ef6bc922a32a642d3c4bcc41ea9fdbb6b9ccdcb5225d2c5"));
